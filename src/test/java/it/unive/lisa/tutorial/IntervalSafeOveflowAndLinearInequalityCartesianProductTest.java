...
public class IntervalSafeOveflowAndLinearInequalityCartesianProductTest {
    ...
    public void testUpperBounds() throws ParsingException, AnalysisException {
        ...
        var twoVariablesInequality = TwoVariablesInequalityDomain.TOP;
        var extendedSigns = new ValueEnvironment<>(new IntervalSafeOverflowDomain());
