...
public class SignsIntervalProductTest {
    @Test
    public void testIntervalles() throws ParsingException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/signsointervalproduct.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/signsointervalproduct";
        ...
        conf.abstractState = DefaultConfiguration.simpleState(
                ...
                new SignsIntervalProductDomain(
